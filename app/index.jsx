            ...
            >
                <Animated.View entering={FadeInDown.delay(100).springify()} className="flex items-center">
                    <Text style={{ fontSize: hp(5) }} className="text-white font-bold tracking-wide">
                        Best <Text className="text-rose-600">Workouts</Text>
                    </Text>
                    <Text style={{ fontSize: hp(5) }} className="text-rose-600 font-bold tracking-wide">
                        For <Text className="text-white">You</Text>
                    </Text>
                    <Text style={{ fontSize: hp(3) }} className="text-rose-600 font-bold tracking-wide">
